...
class Project(models.Model):
    ...
    status = models.IntegerField(_("Status"), choices=constants.PROJECT_STATUS_CHOICES, default=constants.PROJECT_STATUS_DEFAULT)
...
class UserProject(models.Model):
    ...
    role = models.IntegerField(_("Role"), choices=constants.ROLE_USERPROJECT_CHOICES, default=constants.ROLE_USERPROJECT_DEFAULT)
...
class UserStage(models.Model):
    ...
    role = models.IntegerField(_("Role"), choices=constants.ROLE_USERSTAGE_CHOICES, default=constants.ROLE_USERSTAGE_DEFAULT)
...
class Task(models.Model):
    ...
    start_date = models.DateField(_("Start date"))
    end_date = models.DateField(_("End date"))
    status = models.CharField(_("Status"), choices=constants.TASK_STATUS_CHOICES, max_length=50)
